...
export const ComboBoxProps = [
  BuildPropListItem({ Name: 'combobox_autosetFirstOption', Prop: 'autosetFirstOption', Title: 'Auto Set First Option', DefaultValue: true })
]

export const ComboBox = {
  Name: 'control_combobox',
  Def: {
    type: 'control_combobox',
    message0: 'Combo Name %1 Label %2 %3 Layout %4 %5 %6',
    args0: [
      {
        type: 'field_input',
        name: 'Name',
