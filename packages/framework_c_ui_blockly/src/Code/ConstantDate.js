...
export const ConstantDate = {
  ...
  Def: {
    ...
    tooltip: 'A Static Date',
    helpUrl: ''
  },
  Code: function (block) {
    var yearstart = block.getFieldValue('YearStart')
    var yearend = block.getFieldValue('YearEnd')
    var month = block.getFieldValue('Month')
    var day = block.getFieldValue('Day')
    var code = `moment('${yearstart}${yearend}${month}${day}', 'YYYYMMDD')`
