...
actions[ah.SetValue] = (state, action) => {
...
actions[ah.AppendArrayValue] = (state, action) => {
  if (!action.payload.key) {
    throw new Error('Invalid key for app state!')
  }
...
actions[ah.UpdateArrayValue] = (state, action) => {
  if (!action.payload.key) {
    throw new Error('Invalid key for app state!')
  }
...
actions[ah.ClearArrayValue] = (state, action) => {
  if (!action.payload.key) {
    throw new Error('Invalid key for app state!')
  }
...
actions[ah.ClearValue] = (state, action) => {
  if (!action.payload.key) {
    throw new Error('Invalid key for app state!')
  }
